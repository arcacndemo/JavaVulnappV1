...
public class LoginController {
        ...
        private String encryptDES(String password) {
                ...
                try {
                        ...
                        // Vulnerability ID: IN00174
                        // Weak Encryption.
                        // If there is data already encrypted with DES, need to come up with strategy to decrypt and encrypt again with AES to avoid issues in production. If the end user is the only one with keys, the system will need to implement an alternative path to leverage previous encryption methods, whenever the user access. And need to add protection against brute force in these cases. For e.g., by enforcing captcha.
                        // *******************************************************************************
                        key = KeyGenerator.getInstance("AES")).generateKey();
// *******************************************************************************
// Changed by Accenture Auto-remediation service according to Scan: EmployeeVulnApp_S1 ,
// Vulnerability ID: IN00176
// Weak Encryption: Missing Required Step .
// *******************************************************************************
SecureRandom secRandom = new SecureRandom();
key.initialize(secRandom.nextInt(1500));

            // *******************************************************************************
            // Changed by Accenture Auto-remediation service according to Scan: EmployeeVulnApp_S1 ,
            // Vulnerability ID: IN00160
